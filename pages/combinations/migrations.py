...
Выполнить после инициализации БД.
"""

def migrate(db):
    """Создать таблицы для связей между модулями"""
    
    # Таблица: Привычка ↔ Биометрика
    db.execute("""
    ...
    # Таблица: Автоматические характеристики от биометрики
    db.execute("""
    ...
    # Таблица: История применённых бонусов (для логирования)
    db.execute("""
